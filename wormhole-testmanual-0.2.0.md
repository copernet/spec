测试手册WHC version 0.2.0

一、测试环境搭建

1. 软件下载：https://github.com/copernet/wormhole/releases/tag/v0.2.0
...
3. 运行及数据同步
   ...
   初次运行0.2.0版本的代码，使用如下命令：`wormholed -startclean=1 -daemon`

   当0.2.0版本启动，且数据同步完成后，下次软件重启时，使用如下命令：`wormholed -daemon`
